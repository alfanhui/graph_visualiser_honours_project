    ...
    this.state = {
      ...
      displayOptionAbout = (uuid) => {
        return(
          ...
          <text x={this.state.menuItemTextXOrigin - this.state.menu_width/4} y={this.state.menuItemTextYOrigin - (this.state.menu_height * .25)} className={classnames("menuItem", "fontAdjustment10_E")}  key ={'AboutAutoUpdate1' + "_" + uuid}>Auto-Update</text>
          ...
          <text x={this.state.menuItemTextXOrigin + this.state.menu_width/4} y={this.state.menuItemTextYOrigin - (this.state.menu_height *.25)} className={classnames("menuItem", "fontAdjustment10_E")}  key ={'AboutUpdateCreate1' + "_" + uuid} >Update-Changes</text>
          ...
          <text x={this.state.menuItemTextXOrigin - this.state.menu_width/4} y={this.state.menuItemTextYOrigin - (this.state.menu_height * .25) + (1 * this.state.menu_height)} className={classnames("menuItem", "fontAdjustment10_E")}  key ={'AboutPaint1' + "_" + uuid}>Paint</text>
          <text x={this.state.menuItemTextXOrigin - this.state.menu_width/4} y={this.state.menuItemTextYOrigin + (this.state.menu_height * .25) + (1 * this.state.menu_height)} className="menuItem" className={classnames("menuItem", "fontAdjustment18")} key ={'AboutPaint2' + "_" + uuid}>{this.props.state.paint ? "ON" : "OFF"}</text>
          ...
          <text x={this.state.menuItemTextXOrigin + this.state.menu_width/4} y={this.state.menuItemTextYOrigin - (this.state.menu_height *.25) + (1 * this.state.menu_height)} className={classnames("menuItem", "fontAdjustment10_E")} key ={'AboutDatabase1' + "_" + uuid} >DATABASE</text>
          <text x={this.state.menuItemTextXOrigin + this.state.menu_width/4} y={this.state.menuItemTextYOrigin + (this.state.menu_height * .25) + (1 * this.state.menu_height)} className={classnames("menuItem", "fontAdjustment18")}
          style={{fill:(this.props.state.databaseError == "#FFFFF" ? 'green' : this.props.state.databaseError )}} 
          ...
          <text x={this.state.menuItemTextXOrigin} y={this.state.menuItemTextYOrigin - (this.state.menu_height *.25) + (2 * this.state.menu_height)} className={classnames("menuItem", "fontAdjustment11")} key ={'AboutCredText1' + "_" + uuid}>Many thanks to my supervisor</text>
          <text x={this.state.menuItemTextXOrigin} y={this.state.menuItemTextYOrigin + (this.state.menu_height *.25) + (2 * this.state.menu_height)} className={classnames("menuItem", "fontAdjustment11")}  key ={'AboutCredText2' + "_" + uuid}>Prof Chris Reed & ARG-Tech</text>
          </g>
        );
      }
        ...
        */ 
        ...
        render() {
          ...
          return(
            ...
            <text x={this.state.origin*1.2} y={this.state.origin + (this.state.menu_height *.3)} className={classnames("menuDetails", "fontAdjustment12")} key={'menuMainArrayDetails1' + menu.x + menu.y} >{"Nodes: (" + this.props.state.nodes.length + ")"}</text>
            <text x={this.state.origin*1.2} y={this.state.origin + (this.state.menu_height *.6)} className={classnames("menuDetails", "fontAdjustment12")} key={'menuMainArrayDetails2' + menu.x + menu.y} >{"Edges: (" + this.props.state.links.length + ")"}</text>
            {
              this.props.state.updateAvailable
              ?
              <text x={this.state.origin*1.2} y={this.state.origin + (this.state.menu_height *.9)} className={classnames("menuDetails", "fontAdjustment12")} key={'menuMainArrayDetails3' + menu.x + menu.y} stroke="none" fill="red">{"Update Available!"}</text>
              :
              <text x={this.state.origin*1.2} y={this.state.origin + (this.state.menu_height *.9)} className={classnames("menuDetails", "fontAdjustment12")} key={'menuMainArrayDetails3' + menu.x + menu.y} >{"Last updated: " + this.props.state.lastUpdated}</text>
            }
            {this.menuItems(menu)}
            </g>
          );
